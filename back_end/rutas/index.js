...
const sala_pelicula = require("../controllers/sala_pelicula.controller");
const send_mail = require("../controllers/send_mail.controller");
const raw = require("../controllers/raw.controller");
